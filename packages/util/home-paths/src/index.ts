/**
 * Shared filesystem path helpers for Krokki Harness user data.
 *
...
/** Directory name for the default Krokki Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default Krokki Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default Krokki Harness home. */
...
/**
 * Resolve the default Krokki Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root Krokki Harness home.
 *
...
/**
 * Join path segments onto the resolved Krokki Harness home.
